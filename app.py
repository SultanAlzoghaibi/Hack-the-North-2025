                        ...
                        html.Div([
                            ...
                            dcc.Dropdown(
                                ...
                                options=[
                                    ...
                                    {"label": "University of Calgary", "value": "ucalgary"},
        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        html.P("Powered by Databricks • Data from Real Students", style={"margin": "0"}),
...
def display_page(pathname):
    if pathname and pathname.startswith("/chat"):
        DatabricksChatbot.set_university(pathname.split("/")[-1])
